...
#os.path.dirname(os.path.realpath(__file__)).replace("scripts","models/isaretler/")
def setParkSlots():
    ...
    spawn_model_prox[0]('park_yeri_'+str(0), park_yeri_model, "oto_name_space", model_pose, "world")
    model_pose.position.y += 2.4
    for i in range(1,NUMBER_OF_PARK_SLOT-1):
        ...
        model_pose.position.y += 2.4
    spawn_model_prox[NUMBER_OF_PARK_SLOT-1]('park_yeri_'+str(NUMBER_OF_PARK_SLOT-1), park_yeri_model, "oto_name_space", model_pose, "world")
    """
